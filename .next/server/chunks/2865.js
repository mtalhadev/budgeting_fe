...
/* harmony import */ var _mui_material_TextField__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92870);
...
const te = (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_2__.styled)((_mui_material_TextField__WEBPACK_IMPORTED_MODULE_3___default()))`
  input {
    text-align: center;
  }
`, ne = {
  TextFieldStyled: te
}, re = (r) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ne.TextFieldStyled, { ...r }), y = {
  left: "ArrowLeft",
  right: "ArrowRight",
  backspace: "Backspace",
  home: "Home",
...
function M(r) {
  const o = react__WEBPACK_IMPORTED_MODULE_1___default().useRef(() => {
    throw new Error("Cannot call an event handler while rendering.");
  });
  return react__WEBPACK_IMPORTED_MODULE_1___default().useInsertionEffect(() => {
    o.current = r;
  }), react__WEBPACK_IMPORTED_MODULE_1___default().useCallback((...u) => o.current?.(...u), []);
}
const ce = () => !0, he = react__WEBPACK_IMPORTED_MODULE_1___default().forwardRef(
  (r, o) => {
    const {
      value: u = "",
      length: c = 4,
      ...
      onBlur: N,
      ...b
    } = r, K = react__WEBPACK_IMPORTED_MODULE_1___default().useRef(u), V = M(d), g = M((e) => ({
    ...
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
      _mui_material_Box__WEBPACK_IMPORTED_MODULE_4__["default"],
      {
        ...
        ...b,
        children: i.map(({ character: e, inputRef: t }, n) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
          re,
          {
            autoFocus: h ? n === 0 : !1,
