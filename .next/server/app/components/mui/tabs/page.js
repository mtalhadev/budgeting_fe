...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 19033)), "/Users/xperia/Workspace/budgeting_fe-main/src/app/components/mui/tabs/page.tsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 18275)), "/Users/xperia/Workspace/budgeting_fe-main/src/app/not-found.tsx"],
    ...
    const pages = ["/Users/xperia/Workspace/budgeting_fe-main/src/app/components/mui/tabs/page.tsx"];

    

    const originalPathname = "/components/mui/tabs/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/components/mui/tabs/page","pathname":"/components/mui/tabs","bundlePath":"app/components/mui/tabs/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 71321))
...
/* harmony import */ var _mui_material_Tab__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(307);
/* harmony import */ var _mui_material_Tab__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_mui_material_Tab__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _mui_material_Box__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(43872);
/* harmony import */ var _mui_material_Tabs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(87726);
/* harmony import */ var _mui_material_Tabs__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_mui_material_Tabs__WEBPACK_IMPORTED_MODULE_10__);
...
// ----------------------------------------------------------------------
function TabsView() {
    const [currentTab, setCurrentTab] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("one");
    const [scrollableTab, setScrollableTab] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("one");
    const handleChangeTab = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((event, newValue)=>{
        setCurrentTab(newValue);
    }, []);
    const handleChangeScrollableTab = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((event, newValue)=>{
                    ...
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_component_block__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material_Stack__WEBPACK_IMPORTED_MODULE_9__["default"], {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Tabs__WEBPACK_IMPORTED_MODULE_10___default()), {
                                        value: currentTab,
                                        onChange: handleChangeTab,
                                        children: TABS.slice(0, 3).map((tab)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Tab__WEBPACK_IMPORTED_MODULE_11___default()), {
                                                value: tab.value,
                                                label: tab.label
                                            }, tab.value))
                                    }),
                                    TABS.slice(0, 3).map((tab)=>tab.value === currentTab && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material_Box__WEBPACK_IMPORTED_MODULE_6__["default"], {
                                            sx: {
                                                p: 2,
                                                borderRadius: 1,
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_component_block__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
                            title: "Icon",
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Tabs__WEBPACK_IMPORTED_MODULE_10___default()), {
                                value: currentTab,
                                onChange: handleChangeTab,
                                children: TABS.slice(0, 3).map((tab)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Tab__WEBPACK_IMPORTED_MODULE_11___default()), {
                                        icon: tab.icon,
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_component_block__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
                            ...
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material_Box__WEBPACK_IMPORTED_MODULE_6__["default"], {
                                ...
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Tabs__WEBPACK_IMPORTED_MODULE_10___default()), {
                                    ...
                                    children: TABS.map((tab)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Tab__WEBPACK_IMPORTED_MODULE_11___default()), {
                                            label: tab.label,
                                            value: tab.value
                                        }, tab.value))
                                })
...
;// CONCATENATED MODULE: ./src/sections/_examples/mui/tabs-view.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/Users/xperia/Workspace/budgeting_fe-main/src/sections/_examples/mui/tabs-view.tsx`)
...
/* harmony default export */ const tabs_view = (__default__);
;// CONCATENATED MODULE: ./src/app/components/mui/tabs/page.tsx
// sections
...
function TabsPage() {
    return /*#__PURE__*/ jsx_runtime_.jsx(tabs_view, {});
}
...
var __webpack_exports__ = __webpack_require__.X(0, [8071,6566,1276,7782,6222,7299,9428,9215,6831,640,349,3081], () => (__webpack_exec__(48223)));
