...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 22779)), "/Users/xperia/Workspace/budgeting_fe-main/src/app/dashboard/tour/[id]/edit/page.tsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 18275)), "/Users/xperia/Workspace/budgeting_fe-main/src/app/not-found.tsx"],
    ...
    const pages = ["/Users/xperia/Workspace/budgeting_fe-main/src/app/dashboard/tour/[id]/edit/page.tsx"];

    

    const originalPathname = "/dashboard/tour/[id]/edit/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/dashboard/tour/[id]/edit/page","pathname":"/dashboard/tour/[id]/edit","bundlePath":"app/dashboard/tour/[id]/edit/page","filename":"","appPaths":[]}}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   as: () => (/* binding */ _tours)
/* harmony export */ });
/* unused harmony exports TOUR_DETAILS_TABS, TOUR_SORT_OPTIONS, TOUR_PUBLISH_OPTIONS, TOUR_SERVICE_OPTIONS, _tourGuides, TRAVEL_IMAGES */
/* harmony import */ var src_assets_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61338);
/* harmony import */ var _mock__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28672);
/* harmony import */ var _assets__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(65935);
// assets
...
const BOOKER = [
    ...Array(12)
        ...
        id: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.id(index),
        guests: index + 10,
        name: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.fullName(index),
        avatarUrl: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.image.avatar(index)
    }));
const _tourGuides = [
    ...Array(12)
].map((_, index)=>({
        ...
        name: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.fullName(index),
        avatarUrl: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.image.avatar(index),
        phoneNumber: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.phoneNumber(index)
    }));
const TRAVEL_IMAGES = [
    ...Array(16)
].map((_, index)=>_mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.image.travel(index));
const _tours = [
    ...Array(12)
].map((_, index)=>{
    const available = {
        startDate: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.time(index + 1),
        endDate: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.time(index)
    };
    const publish = index % 3 ? "published" : "draft";
    const destination = src_assets_data__WEBPACK_IMPORTED_MODULE_0__/* .countries */ .h.map((option)=>option.label)[index];
    ...
    return {
        ...
        bookers: BOOKER,
        content: CONTENT,
        tags: _assets__WEBPACK_IMPORTED_MODULE_2__/* ._tags */ .Qw.slice(0, 5),
        name: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.tourName(index),
        createdAt: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.time(index),
        durations: "4 days 3 nights",
        price: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.number.price(index),
        priceSale: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.number.price(index),
        totalViews: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.number.nativeL(index),
        ratingNumber: _mock__WEBPACK_IMPORTED_MODULE_1__/* ._mock */ .Q.number.rating(index)
    };
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TourEditPage),
/* harmony export */   generateStaticParams: () => (/* binding */ generateStaticParams),
/* harmony export */   metadata: () => (/* binding */ metadata)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56786);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var src_mock_tour__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86026);
/* harmony import */ var src_sections_tour_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31286);
// _mock
...
function TourEditPage({ params }) {
    const { id } = params;
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(src_sections_tour_view__WEBPACK_IMPORTED_MODULE_2__/* .TourEditView */ .AE, {
        id: id
    });
}
async function generateStaticParams() {
    return src_mock_tour__WEBPACK_IMPORTED_MODULE_1__/* ._tours */ .as.map((tour)=>({
            id: tour.id
        }));
}
...
var __webpack_exports__ = __webpack_require__.X(0, [8071,6566,8111,1276,7782,6017,2870,9177,413,4724,449,8079,6267,569,4622,8897,298,2865,5915,6856,2153,6186,6209,1857,3610,6801,1820,1723,1026,9882,9428,9189,2774,1678], () => (__webpack_exec__(96389)));
